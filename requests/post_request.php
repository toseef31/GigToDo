								...
								<div class="col-md-10 col-sm-12">
									<div class="row">
										<div class="col-xl-9 col-lg-12">
											...
											<div class="form-group">
												<textarea name="request_description" id="textarea" rows="5" cols="73" maxlength="380" class="form-control" placeholder="Request Description" required=""><?= $form_data['request_description']; ?></textarea>
											</div>
											<div class="form-group">
								...
								<div class="row mb-4">
									...
									<div class="col-md-11 col-sm-12 mt-3 ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<label class="custom-control custom-radio">
											<input type="radio" value="<?= $delivery_proposal_title; ?>" <?php if($form_data['delivery_time'] == $delivery_proposal_title){ echo "checked"; } ?> name="delivery_time" class="custom-control-input" required="">
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12 offset-md-1 mt-3">
										<div class="input-group form-curb">
											...
											<input type="number" name="request_budget" min="5" placeholder="5 Minimum" class="form-control input-lg" value="<?= $form_data['request_budget']; ?>" required>
										</div>
									</div>
								</div>
							</div>
