							...
							<div class="col-12 col-md-8">
								<nav class="list-page-nav">
									<div class="nav nav-tabs" id="nav-tab" role="tablist">
										...
										?>
										<a class="nav-item nav-link limerick active" id="active-tab" data-toggle="tab" href="#nav-active" role="tab" aria-controls="nav-active" aria-selected="true">Active <span class="badge"><?php echo $count_requests; ?></span></a>
										<?php
										  $count_requests = $db->count("buyer_requests",array("seller_id" => $login_seller_id, "request_status" => 'pause'));
										?>
										<a class="nav-item nav-link selective-yellow" id="paused-tab" data-toggle="tab" href="#nav-paused" role="tab" aria-controls="nav-paused" aria-selected="false">Paused <span class="badge"><?php echo $count_requests; ?></span></a>
										<?php
                    	$count_requests = $db->count("buyer_requests",array("seller_id" => $login_seller_id, "request_status" => 'pending'));
                		?>
										<a class="nav-item nav-link selective-blue" id="pending-tab" data-toggle="tab" href="#nav-pending" role="tab" aria-controls="nav-pending" aria-selected="false">Pending Approval <span class="badge"><?php echo $count_requests; ?></span></a>
										<?php
										  $count_requests = $db->count("buyer_requests",array("seller_id" => $login_seller_id, "request_status" => 'unapproved'))
										?>
										<a class="nav-item nav-link selective-red" id="unapproved-tab" data-toggle="tab" href="#nav-unapproved" role="tab" aria-controls="nav-unapproved" aria-selected="false">Unapproved <span class="badge"><?php echo $count_requests; ?></span></a>
									</div>
								</nav>
							</div>
						</div>
											...
											<tr role="row">
												...
												<td data-label="Actions">
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
															<a class="dropdown-item" href="active_request?request_id=<?php echo $request_id; ?>">Activate</a>
															<a class="dropdown-item" href="delete_request?request_id=<?php echo $request_id; ?>">Delete</a>
														</div>
													</div>
												</td>
