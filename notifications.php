...
<head>
	<title><?php echo $site_name; ?> - <?php echo $lang["titles"]["notifications"]; ?></title>
	<meta charset="utf-8">
...
<div class="container">
	<div class="row">
		<div class="col-md-12 mt-5">
			<h2> <?php echo $lang["titles"]["notifications"]; ?> </h2>
			<div class="table-responsive box-table mt-5">
				<h2 class="mt-3 mb-3 ml-3"> All <?php echo $lang["titles"]["notifications"]; ?> </h2>
					...
					<td class="inbox-seller">
			          <?php if(!empty($sender_image)){ ?>
				          <?php if(strpos($sender_id, "admin_") !== false){ ?>
				            <img src="admin/admin_images/<?php echo $sender_image; ?>" class="rounded-circle">
				          <?php }else{ ?>
			          ...
			          <?php } ?>
					<h6 class="mb-4">
					<a href="<?php echo $site_url; ?>/notifications?n_id=<?php echo $notification_id; ?>"><?php echo $sender_user_name; ?></a>
					</h6>
					</td>
					<td width="400">
					<a href="<?php echo $site_url; ?>/notifications?n_id=<?php echo $notification_id; ?>">
					<?php echo include("includes/comp/notification_reasons.php"); ?>
					</a>
					</td>
					<td> <?php echo $date; ?> </td>
					<td>
					<a href="notifications?delete=<?php echo $notification_id; ?>" class="text-white btn btn-danger">
      ...
      if($count_all_notifications == 0){
        echo "<center><h3 class='pt-4 pb-4'> <i class='fa fa-meh-o'></i> You have no notifications at the moment.</h3></center>";
      }
      ?>
			</div>
		</div>
