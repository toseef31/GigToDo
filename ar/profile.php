                        ...
                        <td data-label="الأحداث">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="ar/pause_request?request_id=<?php echo $request_id; ?>">
                                وقف
                              </a>
                              <a class="dropdown-item" href="ar/delete_request?request_id=<?php echo $request_id; ?>">
                                حذف
                              </a>
                            </div>
                          </div>
                  ...
                  <div class="managerequest">
                    ...
                    <div class="mangaerequest-body">
                      <table class="table managerequest-table" cellpadding="0" cellspacing="0" border="0">
                        <thead>
                          <tr role="row">
                            <th role="column">المشترى </th>
                            <th role="column">الطلب </th>
                            <th role="column">العروض </th>
                            <th role="column">التسليم </th>
                            <th role="column">الميزانية</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr role="row" id="request_tr_<?= $request_id; ?>">
                            ...
                            <td data-label="الميزانية">
                              ...
                              <?php } else { ?>
                                <a class="send-offer send_button_<?= $request_id; ?>">
                                  ارسل العرض
                                </a>
                              <?php } ?>
                              </div>
...
<div class="modal-content">
  ...
  <h5 class="modal-title h5"><i class="fa fa-frown-o fa-move-up"></i> تم بلوغ حصة الطلب</h5>
  <button class="close" data-dismiss="modal"> &times; </button>
  </div>
  <div class="modal-body">
  <center>
  <h5>يمكنك فقط إرسال 10 عروض كحد أقصى يوميًا. اليوم لقد بلغت الحد الأقصى. حاول مرة أخرى غدا. </h5>
  </center>
  </div>
  <div class="modal-footer">
  <button class="btn login-button" data-dismiss="modal">قريب</button>
  </div>
</div>
</div>
</div>
