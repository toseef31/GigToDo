...
<!-- End Google Tag Manager -->
  ...
  <body class="is-responsive">
            ...
            <div class="row">
              <div class="col-lg-12">
                <table class="table-responsive">
                    ...
                    <tr>
                      ...
                      <td class="order-status" data-payment-id="<?php echo $payment->id ?>">
                          ...
                          <?php elseif($payment->order_id == null && $payment->paid): ?>
                            <a href="/ar/weaccept/create_order?payment_id=<?php echo $payment->id ?>" style=" color: #FF0000;">Create Order</a>
                          <?php else: ?>
                  ...
                  <?php
                  if(count($payments) == 0){
                    echo "<center><h3 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> ليس لديك مدفوعات لعرضها.</h3></center>";
                  }
                  ?>
                </table>
              </div>
    ...
    <script src="<?= $site_url; ?>/ar/js/payments.js"></script>
