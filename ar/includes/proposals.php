	...
	<div class="gigs-content">
		<div class="gigs-author d-flex align-items-center">
			...
			<div class="author-name media-body">
				<a href="<?= $site_url; ?>/ar/<?= $seller_user_name; ?>" style="color: #353535;"><?= $seller_user_name; ?></a>
			</div>
		</div>
		<h4 class="gigs-title"><a href="<?= $site_url; ?>/ar/proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>"><?= $proposal_title; ?></a></h4>
