<?php
  ...
  <div class="gigs-sidebar">
    ...
    <div class="gigs-sidebar-price">
      <div class="gigs-sidebar-title">
        <h4 class="title"><img src="<?= $site_url;?>/assets/img/gigs/price.png" alt="">السعر</h4>
      </div>
    ...
    <div class="gigs-sidebar-status">
      <div class="gigs-sidebar-title">
        <h4 class="title"><img src="<?= $site_url;?>/assets/img/gigs/status.png" alt="">الحالة </h4>
      </div>
    ...
    <div class="gigs-sidebar-titme">
      <div class="gigs-sidebar-title">
        <h4 class="title"><img src="<?= $site_url;?>/assets/img/gigs/time.png" alt="">ميعاد التسليم </h4>
      </div>
