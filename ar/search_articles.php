...
<title> <?php echo $site_name; ?> - Search Articles </title>
<meta charset="utf-8">
...
<a class="navbar-brand logo text-success " href="<?php echo $site_url; ?>">
...
<input type="text" name="search_query" required class="form-control" value="<?php echo $input->get('search'); ?>"  placeholder="Search Questions">
...
<h3 class="make-black pb-1"><i class="fa fa-bars"></i> Search Results For <?php echo $input->get('search'); ?> </h3> <!-- Category -->
...
<i class="fa fa-book"></i> <?php echo $article_heading; ?></a></h6>
