						...
						<div class="row">
							...
							<div class="col-12 col-md-6 align-items-end justify-content-end d-flex flex-row">
							  <div class="purchases-title" style="font-size: 32px;">
							  	متاح للسحب: <span class="font-weight-bold" style=" color: #FF0000;"> <?= $s_currency; ?><?= $current_balance; ?> </span>
								</div>
							</div>
						</div>
						<div class="row">
											...
											<div class="purchases-blance-item">
												<div class="purchases-blance-table">
													...
													<div class="purchases-text">
														<h4>المشتريات الكلية <span><?= $s_currency; ?><?= $used_purchases; ?></span></h4>
													</div>
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-6">
											<div class="purchases-blance-item">
												<div class="purchases-blance-table">
													...
													<div class="purchases-text">
														<h4>الطلبات المفعلة اللي اتباعت <span><?= $s_currency; ?><?= $withdrawn; ?></span></h4>
													</div>
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-6">
											<div class="purchases-blance-item">
												<div class="purchases-blance-table">
													...
													<div class="purchases-text">
														<h4>المشتريات المكتملة <span><?= $s_currency; ?><?= $pending_clearance; ?></span></h4>
													</div>
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-6">
											<div class="purchases-blance-item">
												<div class="purchases-blance-table">
													...
													<div class="purchases-text">
														<h4>الرصيد الشخصي <span><?= $s_currency; ?><?= $current_balance; ?></span></h4>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-12 col-md-6 col-lg-9 d-flex flex-row justify-content-start align-items-start">
								...
								<div class="d-flex flex-wrap align-items-start">
									...
									<a class="withdraw-btn" href="javascript:void(0);">اسحب</a>
								</div> -->
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td style="text-align: left; color: #FF0000;">+<?= $s_currency; ?><?= $amount; ?>.00</td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
