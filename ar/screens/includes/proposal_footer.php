...
<div class="row mb-3"><!--- row Starts --->
	<div class="col-md-12">
		...
		<a class="<?=($lang_dir == "right" ? 'text-right':'')?>" href="../../tags/<?php echo $tag; ?>"><span><?php echo $tag; ?></span></a>
		</div>
		<?php } ?>
	...
	<div class="col-md-12">
		...
		Copyright © <a href="#" class="text-primary strike"><?php echo ucfirst($proposal_seller_user_name); ?></a> All Rights Reversed.
		</p>
		<?php
