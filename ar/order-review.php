...
<head>
  ...
  <!--====== Rateyo css ======-->
  <link href="<?= $site_url; ?>/ar/assets/css/jquery.rateyo.css" rel="stylesheet">
  <!--====== Default css ======-->
                ...
                <div class="order-card">
                  <div class="order-require">
                    <div class="order-require-header d-flex flex-wrap align-items-start">
                      ...
                      <div class="text">
                        <span>ردود فعل الجمهور</span>
                        <span>شارك خبراتك مع المجتمع ، عشان تساعدهم ياخدوا قرارات أفضل.</span>
                      </div>
                    </div>
                  </div>
                  <div class="rating-container d-flex flex-column">
                    <div class="rating-items d-flex flex-row align-items-start justify-content-between">
                      <div class="rating-content">
                        <h4>تقييم عام</h4>
                        <p>كيف كان البائع خلال العملية؟</p>
                      </div>
                    ...
                    <div class="rating-items d-flex flex-row align-items-start justify-content-between">
                      <div class="rating-content">
                        <h4>التواصل مع مقدم الخدمة</h4>
                        <p>ردود مقدم الخدمة كانت ازاي خلال العملية؟</p>
                      </div>
                    ...
                    <div class="rating-items d-flex flex-row align-items-start justify-content-between">
                      <div class="rating-content">
                        <h4>الخدمة زي ما اتوصفت</h4>
                        <p>هل النتيجة متوافقة مع وصف الخدمة؟</p>
                      </div>
                    ...
                    <div class="rating-items d-flex flex-row align-items-start justify-content-between">
                      <div class="rating-content">
                        <h4>اشتري مرة كمان أو وصي بيه</h4>
                        <p>هتوصي الناس يشتروا الخدمة دي؟</p>
                      </div>
                    ...
                    <div class="rating-items d-flex flex-wrap align-items-start">
                      <div class="rating-content">
                        <h4>الشغل كان ازاي مع مقدم الخدمة؟</h4>
                      </div>
                      <form method="POST">
                        ...
                        <div class="row flex-row-reverse">
                          <div class="col-12 col-sm-4">
                            <div class="selected-gig-item d-flex flex-column">
                              ...
                              <div class="text">اضف إلى تقييمك</div>
                            </div>
                          </div>
                          <div class="col-12 col-sm-8">
                            <textarea class="form-control" placeholder="لليه اشتريت الخدمة دي؟ و هل مقدم الخدمة ساعدك عشان تحقق هدفك؟" rows="5" name="review"><?= $buyer_review ?></textarea>
                        ...
                        <div class="row">
                          <div class="col-12 col-sm-8 d-flex flex-row justify-content-end">
                            <button class="button button-red" type="submit" name="buyer_review_submit">التقديم</button>
                          </div>
                        </div>
                        <?php } ?>
                      </form>
