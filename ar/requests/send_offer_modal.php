		...
		<div class="modal-content">
			...
			<div class="modal-body p-0">
				...
				<div class="form-group d-flex flex-row align-items-center justify-content-between">
					...
					<button class="button" id="submit-proposal" data-toggle="modal" data-dismiss="modal" data-target="#submit-proposal-details" title="Choose an offer before clicking continue">استمر</button>
				</div>
			</div>
		</div>
	</div>
...
$(document).ready(function(){
   ...
   $.ajax({
	...
	url: "<?php echo $site_url; ?>/ar/requests/submit_proposal_details",
