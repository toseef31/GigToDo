                    ...
                    <div class="row align-items-center" id="client_find">
                      <div class="col-md-6">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              منجز فيه مجموعة مختلفة من الفريلانسرز الجاهزين انهم يشتغلوا ويمسكوا مشروعك. هتلاقى بسهولة كل الناس من المبرمجين، المصممين، الكُتاب وأكتر بكتير
                            </li>
                            <li>
                              مهما كانت الخدمة الاحترافية اللى بتدور عليها، هتلاقيها على منجز
                            </li>
                            <li>
                              البحث عن مُقدم خدمات مُستقل عنده مهارة وخبرة عملية مُهمّة ومحتاجة تركيز في ظل الخيارات الكتير المُتاحة على منصات العمل الحُر المختلفة. احنا في مُنجز بنوفرلك الخيارات المثالية  لأفضل مُقدمين خدمات مُستقلين، مش هتتعب تاني في البحث ما بين المنصّات المُختلفة ومش هتضطر تستلم شغل أقل من توقعاتك
                            </li>
                            <li>
                              مع منجز، ممكن توثق أوراق اعتمادك، أعمالك السابقة، وشهادات العملء لكل بايع بيستخدم منصة منجز
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center" id="client_hire">
                      <div class="col-md-6 order-md-last">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              مع منجز، معاك الأدوات اللازمة علشان تراجع المرشحين المفضلين، تشوف مراجعاتهم اللى قبل كدة، بروتوفوليو الشغل، وأكتر بكتير.
                            </li>
                            <li>
                              اتفرج على العروض المتقدمة واختار أحسن فريلانسرز لمشروعك. التعيين على منجز بيديك قوة الاستفادة من العرض اللى مبينتهيش من الفريلانسرز اللى بيتنافسوا على مشروعك
                            </li>
                            <li>
                            ...
                            <li>
                              مع منجز، صنع حلمك على بعد خطوة بس
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center" id="client_work">
                      <div class="col-md-6">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              منجز بيديك القوة انك تشغل تجارتك بكفاءة. استمتع بالمنصة سهلة الاستخدام اللى بتسمحلك انك تبعت وتستقبل ملفات، تشارك الفيدباك، تطلب مراجعات وتتواصل بسهولة
                            </li>
                            <li>
                            ...
                            <li>
                              منجز فخور بنفسه لمحافظته على مستوى عالى من المعايير اللى بتضمن ان المشترين يلاقوا بس مستوى عالي من العمل الاحترافى
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 order-md-last">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            ...
                            <li>
                              أحسن جزئية ان منجز بيدير نقل الفلوس من المشترى للبايع. دة بيضمن ان الفريلانسرز عندهم حماس انهم يعملوا كل اللى يقدروا عليه للمشترى.
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center" id="freelancer_find">
                      <div class="col-md-6">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              تصفّح قوائم المشاريع المعروضة، وهتلاقي المشروع اللي يناسبك ويحققلك أكبر ربح وترتاح في الشغل فيه. المُشترين على منصتنا عندهم مشاريع متنوعة وبيدورو على كل خدماتك اللي تقدر توفرها
                            </li>
                            <li>
                              متفوتش الفرصة في انك تلاقي المشاريع المثالية المُناسبة ليك. احنا مؤمنين بمهاراتك و بقُدرتك على انجازها بأفضل شكل
                            </li>
                            <li>
                              انت مصمم جرافيك، كاتب، مبرمج، أو أى حاجة تانية؟ دور على الوظايف اللى متوجهة لمجموعة مهاراتك بالتحديد على منجز
                            </li>
                            <li>
                    ...
                    <div class="row align-items-center" id="freelancer_hire">
                      <div class="col-md-6 order-md-last">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              منجز بيخلى الموضوع بسيط جدًا انك تلاقى عملاء محتاجين خدمتك. منصتنا مخصصة انها تضمن ان أحسن البائعين يلاقوا المشترى المناسب
                            </li>
                            <li>
                    ...
                    <div class="row align-items-center" id="freelancer_work">
                      <div class="col-md-6">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              جرد ما تبدأ شغل، هيساعدك انك تفضل فى تواصل دايم مع المشترى. خليك فى تواصل قريب على منصة منجز واضمن ان عملائك يفضلوا راضيين بنسبة 100% طول الوقت
                            </li>
                            <li>
                    ...
                    <div class="row align-items-center" id="freelancer_pay">
                      <div class="col-md-6 order-md-last">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>
                              كبايع، منجز بيضمن ان عملائك هيدفعولك بطريقة آمنة وفى الوقت المظبوط. عمرك ما تقلق عن استلامك لفلوسك
                            </li>
                            <li>
                              حافظ على سجل كامل بالفواتير اللى جاية والفواتير القديمة من خلال التطبيق البديهى
                            </li>
                            <li>
                              منجز  بيوفرلك دايما كل أدوات وبيانات التبليغ اللى محتاجها علشان تتابع مكاسبك، والمدفوعات المستقبلية. احنا عايزينك تاخد حياتك المهنية فى الفريلانسينج (الأعمال الحرة) للمستوى اللى جاى
                            </li>
                            <li>
                              مع منجز، هتقدر تستفيد من مواهبكوتتفوق فعلا. اشترك النهاردة علشان تبدأ تكسب فلوس حقيقية بسرعة
                            </li>
                          </ul>
                        </div>
                      </div>
