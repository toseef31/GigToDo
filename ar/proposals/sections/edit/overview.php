			...
			<div class="row">
				<div class="col-12 col-lg-8">
                  ...
                  <div class="d-flex flex-column category_section">
                    <select name="proposal_cat_id" id="category" class="form-control mb-3" required  disabled="true">
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex flex-row mt-10 mb-10">
											<select class="form-control wide">
												<option value="Free Text" <?php if($d_answer_type == 'Free Text'){echo "selected";} ?>>كتابة حرة</option>
												<option value="Attachment" <?php if($d_answer_type == 'Attachment'){echo "selected";} ?>>نص مركب</option>
											</select>
										</div>
