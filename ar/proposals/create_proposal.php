...
<head>
  <script>
    ...
    dataLayer = [{
      'event': 'Pageview',
      'pagePath': 'https://www.emongez.com/ar/proposals/create_proposal',
                ...
                <div class="howitwork-list d-flex flex-column">
                  ...
                  <div class="howitwork-list-item d-flex flex-row align-items-start">
                    ...
                    <div class="howitwork-list-content">
                      <h3>2. التعاقد</h3>
                      <p>
                        اتواصل مع العميل عشان تحددوا التفاصيل الخاصة بالمشروع. بمجرد ما تتفق انت و العميل على الطلبات، هتبدأ الشغل.
                      </p>
                    </div>
                  </div>
                  <!-- How it work each item -->
                  <div class="howitwork-list-item d-flex flex-row align-items-start">
                    ...
                    <div class="howitwork-list-content">
                      <h3>3. الشغل</h3>
                      <p>
                        بمجرد ما تخلص شغلك،هتسلم الشغل على منصتنا عشان العميل يوافق عليه.
                      </p>
                    </div>
                  </div>
                  <!-- How it work each item -->
