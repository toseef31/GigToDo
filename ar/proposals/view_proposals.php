					...
					<div class="container">
								...
								<div class="col-12 col-md-6">
									<nav class="list-page-nav">
										<div class="nav nav-tabs" id="nav-tab" role="tablist">
											...
											?>
											<a class="nav-item nav-link limerick active" id="active-tab" data-toggle="tab" href="#nav-active" role="tab" aria-controls="nav-active" aria-selected="true">فعالة <span class="badge"><?php echo $count_proposals; ?></span></a>
											<?php
										    $count_proposals = $db->count("proposals",array("proposal_seller_id" => $login_seller_id, "proposal_status" => 'pause'));
											?>
											<a class="nav-item nav-link selective-yellow" id="paused-tab" data-toggle="tab" href="#nav-paused" role="tab" aria-controls="nav-paused" aria-selected="false">متوقفة <span class="badge"><?php echo $count_proposals; ?></span></a>
											<?php
						...
						<div class="row">
	                      ...
	                      ?>
									         ...
									         echo "<center><h3 class='pt-4 pb-4'><i class='fa fa-meh-o'></i> ليس لديك حاليا أزعج للبيع.</h3></center>";
										     }
												?>
												<!-- Each item -->
											</div>
                      ...
                      ?>
		                    ...
		                    ?>
																...
																<div class="icon d-flex flex-row">
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuLink-1">
																			...
																			<a class="dropdown-item" href="activate_proposal?proposal_id=<?php echo $proposal_id; ?>">
																				تنشيط الحفلة
																			</a>
																		</div>
																	</div>
												...
												<?php
										      if($count_proposals == 0){
									         echo "<center><h3 class='pt-4 pb-4'><i class='fa fa-smile-o'></i> ليس لديك حاليًا أزعج متوقف مؤقتًا.</h3></center>";
										      }
												?>
												<!-- Each item -->
											</div>
