          ...
          <div class="profile-verifi mt-20">
            ...
            <div class="profile-verifi-content profile-verifi-2 pt-20">
              <ul>
                ...
                <li onclick="window.open('settings?account_settings');"><i class="fas fa-dollar-sign"></i> اتحققنا من الدفع <span class="verify">تأكيد</span></li>
                <?php } ?>
              </ul>
            </div>
            <?php }else { ?>
              ...
              <div class="row no-gutters">
                <div class="col-md-4">
                  <div class="single-communication mt-15">
                    <h5 class="title">مستوى التواصل لمقدم الخدمة</h5>
                    <span><i class="fa fa-star"></i> <?= $average_rating_communi ?></span>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="single-communication mt-15">
                    <h5 class="title">وصي بيه لصديق</h5>
                    <span><i class="fa fa-star"></i> <?= $average_rating_service ?></span>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="single-communication mt-15">
                    <h5 class="title">الخدمة زي ما اتوصفت</h5>
                    <span><i class="fa fa-star"></i> <?= $average_rating_service ?></span>
                  </div>
                </div>
              </div>
