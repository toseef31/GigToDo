<?php
	...
	if(isset($_SESSION['c_message_offer_id'])){
								...
								<div class="gigs-payment pt-30">
									<ul class="radio_titme radio_style2">
										<li class="pt-30">
											...
											?>
											<form action="conversations/checkout_charge" method="post" id="credit-card-form" style="margin-top: -15px;"><!--- credit-card-form Starts --->
											<input
											type="submit"
											class="stripe-submit"
										...
										<li class="pt-30">
											...
											<?php if($enable_paypal == "yes"){ ?>
											<div class="input-check-area float-left mt-0">
												<form action="conversations/paypal_charge" method="post" id="paypal-form" class="float-left" style="margin-top: -17px;"><!--- paypal-form Starts --->
								...
								<div class="gigs-payment pt-30">
									<ul class="radio_titme radio_style2">
										<li>
											...
											<form action="conversations/weaccept.php" method="post" id="weaccept-form" class="float-right">
							...
							<div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
								...
								<div class="gigs-payment pt-30">
                                  ...
                                  ?>
											...
											?>
											<form action="conversations/weaccept_cash.php" method="post" id="weaccept-cash-form"><!--- paypal-form Starts --->
								...
								<div class="gigs-payment pt-30">
									<ul class="radio_titme radio_style2">
										<li>
											...
											<form action="conversations/weaccept_kiosk.php" method="post" id="weaccept-kiosk" class="float-right">
