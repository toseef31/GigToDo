...
<div class="specfic col-md-9 p-0 <?=($lang_dir == "right" ? 'order-1 order-sm-2':'')?>">
	...
	<center id="selectConversation" class="pt-5 pt-sm-5 pb-5 pb-sm-5">
		<img src="../images/chat.png" width="180" alt="">
		<h3 class="mt-3 empty-heading" style="font-weight:410;">حدد محادثة  </h3>
		<p class="lead">حاول اختيار محادثة أو البحث عن شخص محدد.</p>
	</center>
