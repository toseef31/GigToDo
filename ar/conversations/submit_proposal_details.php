...
<h5 class="modal-title"> حدد تفاصيل اقتراحك </h5>
		...
		<div class="d-flex align-items-start align-items-md-center pt-15 pb-15">
			...
			<div class="profile-content media-body">
				<div class="form-group p-0 m-0">
					<textarea rows="4" class="form-control" name="description" placeholder="اكتب النص هنا" required=""></textarea>
				</div>
			</div>
		</div>
	</div>
<!-- <div class="form-group"> -->
	<!--- form-group Starts --->
<!-- <div class="customer-profile px-0 border-bottom-0">
<label class="font-weight-bold"> وصف :  </label>
...
<!-- <label class="font-weight-bold"> متى تريد أن تستلم خدمتك المطلوبة؟   </label>
...
<!-- <label class="font-weight-bold"> ما هى ميزانيتك؟  </label>
...
<div class=""><!--- modal-footer Starts --->
<div class="form-group d-flex flex-row align-items-center justify-content-between">
<button type="button" class="btn btn-secondary button-close" data-dismiss="modal" data-toggle="modal" data-target="#send-offer-modal">عودة</button>

<button type="submit" class="btn btn-success button">تقديم صفقة</button>
</div>
