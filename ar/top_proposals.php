...
<head>
<title> <?php echo $site_name; ?> - Top Rated Proposals/Services </title>
...
<div class="container-fluid mt-5"> <!-- Container start -->
  <div class="row">
    <div class="col-md-12">
      <center>
      <h1> Top Rated Proposals/Services </h1>
      <p class="lead">This is an extended list of our top rated proposals/services</p>
      </center>
      <hr class="mt-5 pt-2">
    </div>
  </div>
