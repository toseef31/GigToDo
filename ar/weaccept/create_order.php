...
header("Location:"."/ar/weaccept_order?checkout_seller_id=$payment->seller_id&proposal_id={$payment->proposal_id}&proposal_qty={$proposalQty}&proposal_price={$subTotal}&$extras");