									...
									<div class="d-flex flex-column align-items-center">
										...
										<ul class="list-inline d-flex flex-row align-items-center justify-content-center">
											<li class="list-inline-item">
												<a class="list-inline-link facebook" href="http://www.facebook.com/sharer.php?u=<?php echo $site_url; ?>/ar/register?referral=<?php echo $login_seller_referral; ?>" target="_blank">
													<i class="fab fa-facebook-f"></i>
												</a>
											</li>
											<li class="list-inline-item">
												<a class="list-inline-link twitter" href="http://twitter.com/share?url=<?php echo $site_url; ?>/ar/register?referral=<?php echo $login_seller_referral; ?>" target="_blank">
	...
	if (isset($_POST['send_email'])) {
		...
		if($check_seller_email > 0){
			...
			echo "<script>
				swal({
				type: 'warning',
				html: $('<div>').text('عذراً! مستخدم لديه هذا البريد الإلكتروني سجل بالفعل. يرجى تجربة واحدة مختلفة.'),
				animation: false,
