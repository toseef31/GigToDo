    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
				...
				<td>
				<a class="btn text-white btn-success" href="index?language_settings=<?php echo $id; ?>" >
					<i class="fa fa-fw fa-cog"></i> Settings
				</a>

				<a class="btn text-white btn-primary" href="index?edit_language=<?php echo $id; ?>" >
					<i class="fa fa-trash-alt"></i> Edit
				</a>

                <?php if($title != "English"){ ?>

				<a class="btn text-white btn-danger" href="index?delete_language=<?php echo $id; ?>" onclick="if(!confirm('Are you sure you want to delete selected item.')){ return false; }">
