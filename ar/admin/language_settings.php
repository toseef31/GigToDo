...
<div class="card-header"><!--- card-header Starts --->
	<i class="fa fa-money fa-fw"></i> Language Settings For <strong><?php echo $title; ?></strong>
...
<textarea name="data" class="form-control" rows="20" required=""><?php echo file_get_contents($file); ?></textarea>
