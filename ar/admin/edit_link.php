...
<input type="text" name="icon_class" class="form-control" required value="<?php echo $icon_class; ?>">

<small><a href="https://fontawesome.com/v4.7.0/icons/" class="btn-link">Click Here</a> To View All Font Awesome Icons Class Names</small>
...
<input type="text" name="link_title" class="form-control" required value="<?php echo $link_title; ?>">
...
<input type="text" name="link_url" class="form-control" required value="<?php echo $link_url; ?>">
