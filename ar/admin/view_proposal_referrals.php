...
<td>
<?php echo $s_currency; ?><?php echo $comission; ?>
</td>
...
<a class="dropdown-item" href="index?approve_proposal_referral=<?php echo $referral_id; ?>" onclick="return confirm('Are you sure you want to approve this referral? if so, <?php echo $s_currency; ?><?php echo $comission; ?>.00 will be added to <?php echo $seller_user_name; ?> shopping balance.');">

<i class="fa fa-thumbs-up"></i> Approve 

</a>

<a class="dropdown-item" href="index?decline_proposal_referral=<?php echo $referral_id; ?>" onclick="return confirm('Are you sure you want to decline this referral? if so, <?php echo $seller_user_name; ?> will receive no commision.');">
