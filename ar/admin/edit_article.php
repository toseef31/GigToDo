...
echo "<script>window.open('login','_self');</script>";
    ...
    if($update_article){
      unlink("../article/article_images/{$row_articles->$remove_image}");
    ...
    <div class="card">
      ...
      <select name="article_status" id="select" class="form-control">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9"><textarea name="article_body" id="textarea-input" rows="19" placeholder="Start Typing Here..." class="form-control"><?php echo $article_body; ?></textarea></div>
          </div>
      <div class="row form-group">
