                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" disabled="" name="title" class="form-control" value="<?php echo $title; ?>" required>
                        ...
                        <img src="../languages/images/<?php echo $image; ?>" width="70" height="55">
...
$update_seller_language = $db->update("languages",array("default_lang"=>$default_lang,"direction" => $direction,"image" => $image),array("id" => $id));
