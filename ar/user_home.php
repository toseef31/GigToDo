      ...
      <div class="col-12 col-lg-8">
        ...
        <div class="home-slide-active pt-40 owl-carousel">
          <?php
            ...
            $i = 0;
            $get_slides = $db->query("select * from slider where language_id='2' LIMIT 1,$count_slides");
            while($row_slides = $get_slides->fetch()){
            $i++;
            ?>
          <?php } ?>
          <?php
            $get_slides = $db->query("select * from slider where language_id='2' LIMIT 0,$count_slides");
            while($row_slides = $get_slides->fetch()){
            ...
            ?>
          <div class="single-slide-item" style="background-image: url('<?= $site_url; ?>/slides_images/<?= $slide_image; ?>');"></div>
          <?php } ?>
        </div>
        <!-- Home-slider  END-->
      </div>
        ...
        <div class="sidebar-box">
          ...
          <div class="sidebar-single-item">
            <div class="sidebar-img">
              <a href="<?= $site_url; ?>/ar/proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>">
