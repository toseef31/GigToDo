<?php if($seller_id == $login_seller_id){ ?>
  <?php if($order_status == "progress" or $order_status == "revision requested"){ ?>
    <div class="message-content-card-item d-flex flex-column">
      <div class="d-flex flex-wrap justify-content-center">
        <a class="d-flex flex-row align-items-center justify-content-center button button-red" data-toggle="modal" data-target="#deliver-order-modal">سلم الآن</a>
      </div>
    </div>
    <!-- <center>
  ...
  <?php if($order_status == "delivered"){ ?>
    <div class="message-content-card-item d-flex flex-column">
      <div class="d-flex flex-wrap justify-content-center">
        <a class="d-flex flex-row align-items-center justify-content-center button button-red" data-toggle="modal" data-target="#deliver-order-modal">تسليم الطلب مرة أخرى</a>
      </div>
    </div>
    <!-- <center>
