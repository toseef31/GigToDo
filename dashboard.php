            ...
            <div class="col-12 col-md-4 d-flex flex-row">
                <div class="userprofile d-flex flex-column">
                    ...
                    <div class="userprofile-footer d-flex flex-column">
                        <a class="userprofile-button d-flex flex-row align-items-center justify-content-center" href="<?= $site_url; ?>/proposals/create_proposal">Post a service</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
              <nav class="list-page-nav">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link limerick active" id="active-tab" data-toggle="tab" href="#nav-active" role="tab" aria-controls="nav-active" aria-selected="true">Active <span class="badge">
                    <?php 
                      $i_requests = 0;
                      $i_send_offers = 0;
                  ...
                  <a class="nav-item nav-link selective-yellow" id="paused-tab" data-toggle="tab" href="#nav-paused" role="tab" aria-controls="nav-paused" aria-selected="false">sent offer <span class="badge"><?php echo $count_offers; ?></span></a>
                </div>
              </nav>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-12 d-flex flex-row justify-content-end">
            <a class="offer-left" href="javascript:void(0);">
              ...
              <span><?php echo $login_seller_offers; ?> offers left today</span>
            </a>
          </div>
        </div>
        <!-- Row -->
