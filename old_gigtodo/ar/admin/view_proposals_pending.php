...
Featured (<?php echo $count_featured_proposals; ?>)
...
Pending Approval (<?php echo $count_pending_proposals; ?>)
...
<a title="Preview this Proposal" href="../proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>" target="_blank">
...
<a title="Submit this Proposal to seller for modification" href="index?submit_modification=<?php echo $proposal_id; ?>">
...
<a title="Approve this Proposal" href="index?approve_proposal=<?php echo $proposal_id; ?>">
