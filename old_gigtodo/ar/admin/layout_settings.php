...
<a href="index?edit_link=<?php echo $link_id; ?>" class="mr-1 ml-2">

<i class="fa fa-pencil"></i>

</a>

<a href="index?delete_link=<?php echo $link_id; ?>" onclick="return confirm('Do you really want to delete this link permanently.')">
...
<i class="fa <?= $icon_class; ?>"></i> <?php echo $link_title; ?> - <span><?php echo ucwords($link_section); ?></span>
...
<i class="fa <?= $icon_class; ?>"></i> - <span> <?php echo ucwords($link_section); ?> </span>
...
<input type="text" name="section_heading" class="form-control" value="<?php echo $db_section_heading; ?>" required="">
...
<input type="text" name="section_short_heading" class="form-control" value="<?php echo $db_section_short_heading; ?>" required="">
...
<img src="../home_slider_images/<?php echo $slide_image; ?>" style="height: 150px; min-width: 100%;" class="img-fluid">

</div><!--- card-body Ends --->

<div class="card-footer"><!--- card-footer Starts --->

<a href="index?delete_home_slide=<?php echo $slide_id; ?>" class="float-left btn btn-danger" title="Delete">

<i class="fa fa-trash text-white"></i> 

</a>

<a href="index?edit_home_slide=<?php echo $slide_id; ?>" class="float-right btn btn-success" title="edit">
...
<h4 class="h4"> <?php echo $card_title; ?> </h4>
...
<a href="index?delete_card=<?php echo $card_id; ?>" class="float-left">

<i class="fa fa-trash-alt"></i> Delete

</a>

<a href="index?edit_card=<?php echo $card_id; ?>" class="float-right">
...
<a href="index?delete_box=<?php echo $box_id; ?>" class="float-left">

<i class="fa fa-trash-alt"></i> Delete

</a>

<a href="index?edit_box=<?php echo $box_id; ?>" class="float-right">
...
$insert_log = $db->insert_log($admin_id,"custom_css","","updated");
