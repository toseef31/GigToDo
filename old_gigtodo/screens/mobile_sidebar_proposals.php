...
<div class="flex-row">
<div class="col-media">
<a href="<?php echo $site_url; ?>/proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>" target="_self">
<div class="media-container">
<div class="media-slider">
<div class="thumbnail-wrapper">
<img src="../proposal_files/<?php echo $proposal_img1; ?>" class="proposal-thumbnail">
</div>
</div>
</div>
</a>
...
<a href="<?php echo $site_url; ?>/proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>" class="proposal-link-main w-100"><h3><?php echo $proposal_title; ?></h3></a>
...
<img src="../../user_images/<?php echo $seller_image; ?>" width="32" height="32">
</span>
<div class="seller-info-wrapper">
<a href="<?php echo $site_url; ?>/<?php echo $seller_user_name; ?>" rel="nofollow" class="seller-name">by <?php echo $seller_user_name; ?></a>
