      ...
      <div data-ui="mobile-cat-nav" class="mobile-cat-nav bg-gray-lighter pb-xs-4 width-full position-fixed animated" style="height: 100vh;">
        ...
        <div class="bg-white display-flex-md show-md pt-md-3 pl-md-2 pb-md-3">
          <div class="flex-md-5 pl-md-0">
            ...
            <img src="<?= $site_url; ?>/images/<?= $site_logo_image; ?>" width="158">
            </a>
          </div>
        ...
        <div data-ui="mobile-catnav-header" class="mobile-catnav-header bb-xs-1 align-items-center bg-white display-flex-xs flex-nowrap position-relative height-50px">
          ...
          <div class="flex-xs-4 width-full pt-md-4 pb-md-4 pl-xs-2">
            <h6 id="mobile-catnav-header-title" class="text-left position-absolute vertical-center"><!--  <a href="<?php echo $site_url; ?>"><img src="images/<?php echo $site_favicon; ?>" class="rounded" title='Home' alt='Home'/></a> --> Browse Categories</h6>
        ...
        <div data-ui="mobile-catnav-scroll-wrapper" class="height-full overflow-y-scroll">
          ...
          <div class="mobile-subnav bg-white animated" id="mobile-sub-catnav-content-d-1">
            ...
            <ul class="mobile-sub-catnav-container list-unstyled mobile-catnav-margin">
              ...
              <li class="p-xs-2 bb-xs-1 text-body-larger subnav-item" data-uid="b" data-name="<?= $lang['buying']; ?>">
                <a href="#">
                  <div class="flag">
                    <div class="flag-body"><?= $lang['buying']; ?></div>
                    <?= $next_icon; ?>
                  </div>
                </a>
              </li>
              ...
              <li class="p-xs-2 bb-xs-1 text-body-larger subnav-item" data-uid="contacts" data-name="<?= $lang['contacts']; ?>">
                <a href="#">
                  <div class="flag">
                    <div class="flag-body"><?= $lang['contacts']; ?></div>
                    <?= $next_icon; ?>
                  </div>
                </a>
              </li>
              <li class="p-xs-2 bb-xs-1 text-body-larger subnav-item" data-uid="referrals" data-name="<?= $lang['my_referrals']['title']; ?>">
                <a href="#">
                  <div class="flag">
                    <div class="flag-body"><?= $lang['my_referrals']['title']; ?></div>
                    <?= $next_icon; ?>
                  </div>
                </a>
              </li>
              <li class="p-xs-2 bb-xs-1 text-body-larger subnav-item">
                <a href="<?= $site_url; ?>/<?= $_SESSION['seller_user_name']; ?>">
                  <div class="flag">
                    <div class="flag-body"><?= $lang['my_profile']; ?></div>
                  </div>
                </a>
              </li>
              <li class="p-xs-2 bb-xs-1 text-body-larger subnav-item" data-uid="settings" data-name="<?= $lang['settings']; ?>">
                <a href="#">
                  <div class="flag">
                    <div class="flag-body"><?= $lang['settings']; ?></div>
                    <?= $next_icon; ?>
                  </div>
                </a>
              </li>
