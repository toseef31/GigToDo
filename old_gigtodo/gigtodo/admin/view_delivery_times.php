            ...
            <table class="table table-bordered">
              ...
              <thead>
                <tr>
                  ...
                  <th> Delivery Title Arabic </th>
                  <th> Listing Delivery Time Title </th>
                  <th> Listing Delivery Title Arabic </th>
              ...
              <tbody>
                ...
                $delivery_title_arabic = $row_delivery_times->delivery_title_arabic;
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $delivery_title_arabic; ?>
                  </td>
                  <td>
                    <?php echo $delivery_proposal_title; ?>
                  </td>
                  <td>
                    <?php echo $delivery_proposal_title_arabic; ?>
                  </td>
                  <td>
                    <a href="index?delete_delivery_time=<?php echo $delivery_id; ?>" onclick="return confirm('Do you really want to delete this delivery time permanently.');" class="btn btn-danger">
                      <i class="fa fa-trash text-white"></i> <span class="text-white">Delete</span>
                    </a>
                  </td>
                  <td>
                    <a href="index?edit_delivery_time=<?php echo $delivery_id; ?>" class="btn btn-success">
