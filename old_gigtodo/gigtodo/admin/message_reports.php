...
<td>
<a href="index?single_inbox_message=<?php echo $content_id; ?>" target="_blank" class="text-success">View Message</a>
</td>
...
<a class="dropdown-item" href="index?delete_message_report=<?php echo $id; ?>">
