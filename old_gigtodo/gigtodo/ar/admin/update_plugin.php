  ...
  <div class="col-sm-6">
    <div class="page-header float-left">
      <div class="page-title">
        <h1><i class="menu-icon fa fa-cog"></i> Update Plugin / <?php echo $pluginName; ?> </h1>
      </div>
    </div>
  </div>
</div>
...
<div class="row mb-4"><!--- 2 row Starts --->
  ...
  <div class="card mb-5"><!--- card mb-5 Starts --->
    <div class="card-header"><!--- card-header Starts --->
      <h4 class="h4 mb-0"> <i class="fa fa-money fa-fw"></i> Update Plugin / <?php echo $pluginName; ?> </h4>
      ...
      <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
        ...
        <div class="form-group row mb-4"><!--- form-group row Starts --->
          ...
          <div class="col-md-6 pl-4 pr-4">
            <input type="submit" name="updatePlugin" value="Update <?php echo $pluginName; ?>" class="btn btn-success form-control">
          </div>
        </div><!--- form-group row Ends --->
      </form><!--- form Ends --->
      </div><!--- card-body Ends --->
