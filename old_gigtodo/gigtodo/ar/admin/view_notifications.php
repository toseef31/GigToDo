...
<tr>
	...
	<img src="../user_images/<?php echo $seller_image; ?>" width="40" class="rounded-circle img-fluid">
	<?php }else{ ?>
	<img src="../user_images/empty-image.png" width="40" class="rounded-circle img-fluid">
	<?php } ?>
	&nbsp;&nbsp; <a href="../<?php echo $seller_user_name; ?>"><?php echo $seller_user_name; ?></a>
	<?php echo @$message; ?>
	</td>
	<td width="190"><?php echo $date; ?></td>
	<td width="290">
	<a href="<?php echo $url; ?>">
		<i class="fa fa-eye"></i>
		<?php 
	...
	&nbsp; | &nbsp;
	<a href="#" onclick="alert_confirm('Do you really want to delete this notification permanently.','index.php?delete_notification=<?php echo $notification_id; ?>');">
