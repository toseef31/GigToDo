<div class="col-12 col-sm-6 col-md-4">
  <div class="search-results-card d-flex flex-column align-items-center">
    <div class="user-image">
    	...
    	<img src="user_images/<?php echo $seller_image; ?>" width="100" class="rounded-circle img-fluid d-block">
    	<?php }else{ ?>
    	<img class="img-fluid d-block" src="user_images/empty-image.png" />
    	<?php } ?>
    </div>
    ...
    <div class="search-results-card-action d-flex flex-row align-items-center justify-content-center">
      <a class="d-flex flex-row align-items-center justify-content-center view-button" href="<?php echo $seller_user_name; ?>">View profile</a>
    </div>
  </div>
</div>
...
<div class="card card-body mb-4 freelancerBox">
	<figure class="wt-userlistingimg">
		...
		<small class="text-muted mt-1">
			<?php echo (check_status($seller_id) == "Online" ? "<i class='fa fa-circle text-success'></i>" : "<i class='fa fa-circle text-danger'></i>") ?>
			<?php echo check_status($seller_id); ?>
		</small>
	...
	<div class="request-description">
		<div class="row">
			<div class="col-lg-9 col-md-12">
				...
				<h6 class="font-weight-normal"><i class="fa fa-check-circle" style="color:#00cc8d;"></i> <?php echo $seller_user_name; ?> </h6>
