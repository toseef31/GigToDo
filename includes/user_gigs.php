...
<div class="product-single-item">
  ...
  <div class="product-text">
    <div class="product-author">
      ...
      <a href="<?= $site_url; ?>/<?= $seller_user_name; ?>" style="color: #434343;"><span><?= $seller_user_name; ?></span></a>
    </div>
    <h5><a href="<?= $site_url; ?>/proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>" style="color: #383838;"><?= $proposal_title; ?></a></h5>
    <div class="rating">
