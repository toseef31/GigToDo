							...
							<div class="row align-items-end">
								...
								<div class="col-12 col-md-7">
									<div class="d-flex flex-column align-items-center">
										<h1 class="text-center">Invite Friends & Get <?php if ($to == 'USD'){ echo $to.' '; echo "5";}elseif($to == 'EGP'){  echo $to.' '; echo round($cur_amount * 5);}else{  echo $s_currency.' '; echo "5"; } ?></h1>
										<p class="text-center">Get 20 EGP off on your next purchase</p>
