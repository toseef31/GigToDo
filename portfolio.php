        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-lg-6 portfolio-header">
              <h1 class="text-center">Build Your Portfolio Gallery</h1>
                ...
                <form method="POST" action="">
                  <label class="file-upload" for="uploadFile">
                    ...
                    <div class="upload-icon">
                      <img class="img-fluid d-block" src="assets/img/portfolio/upload-icon.png" />
                    </div>
                    <h5 class="text-center">drag a photo or</h5>
                    <div class="d-flex flex-row justify-content-center">
                      <div class="browse-button">Browse</div>
                    </div>
                    <p class="text-center"><strong>Please Note:</strong> The image name will be displayed as artwork title.</p>
                  </label>
                </form>
                <div class="suggestion d-flex flex-row align-content-start">
                  <span>
                    <img class="img-fluid d-block" src="assets/img/portfolio/warning-icon.png" />
                  </span>
                  <span>The minimum image dimension should be: 500 width and 800 height</span>
                </div>
                <div class="row gallery">
                  ...
                  <div class="col-6 col-md-3">
                    <div class="portfolio-item">
                      ...
                      <img class="img-fluid d-block" src="portfolio_images/<?= $portfolio_img ?>" />
                      <span><?= $img_name; ?></span>
                      </a>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-body">
                          ...
                          <img class="img-fluid d-block" src="portfolio_images/<?= $portfolio_img ?>" width="100%" />
                        </div>
                      </div>
                    </div>
                  </div>
...
<?php 
  if(isset($_GET['delete_portfolio'])){
    ...
    if($delete_portfolio->rowCount() == 1){
      echo "<script>alert('One Portfolio item has been deleted.')</script>";
