        ...
        <div class="row">
          ...
          <div class="col-12 col-md-8 col-lg-9">
            <div class="search-results-header">
              <h3>Result for <span>"<?php echo @$_SESSION["search_query"]; ?>"</span></h3>
              <div class="contains d-flex flex-row align-items-center">
                ...
                <div class="text">Search gigs containing <span>"<?php echo @$_SESSION["search_query"]; ?>"</span></div>
              </div>
              <h4>Seller profiles</h4>
            </div>
            <div class="row" id="freelancers">
              <?php get_search_freelancers(); ?>
...
<script>
  function get_freelancers(){
    ...
    if(aKeys.length>0){
      for(var i = 0; i < aKeys.length; i++){
      sPath = sPath + 'seller_category[]=' + aKeys[i]+'&';
      }
    }
