									...
									<!-- <form action="#"> -->
										<ul class="radio_titme radio_style2">
											<li class="pt-30">
												...
												?>
												<form action="conversations/stripe_charge" method="post" id="credit-card-form" style="margin-top: -15px;"><!--- credit-card-form Starts --->
												<input
												type="submit"
												class="stripe-submit"
											...
											<li class="pt-30">
												...
												<?php if($enable_paypal == "yes"){ ?>
												<div class="input-check-area float-right mt-0">
													<form action="conversations/paypal_charge" method="post" id="paypal-form" class="float-right" style="margin-top: -17px;"><!--- paypal-form Starts --->
