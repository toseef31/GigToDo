		...
		<div class="modal-body p-0">
			<div class="order-details">
				<div class="request-div">
					<h4 class="mb-3">
					<b>FEATURE LISTING FEE & INFO:</b> <span class="price float-right d-none d-sm-block mb-3 font-weight-bold"><?= $s_currency; ?><?= $featured_fee; ?></span>
					</h4>
					<p>
						You are about to pay a feature listing fee for your proposal/service. This will make this proposal/service feature on our "Featured proposal/service" spots. The fee is <?= $s_currency; ?><?= $featured_fee; ?> and the duration is <?= $featured_duration; ?> Days. Please use any of the following payment methods below to complete payment.
					</p>
					<h4><b>SUMMARY:</b></h4>
					<p><b>Proposal Title:</b> <?= $proposal_title; ?></p>
					<p><b>Feature Listing Fee:</b> <?= $s_currency; ?><?= $featured_fee; ?></p>
					<p><b>Processing Fee:</b> <?= $s_currency; ?><?= $processing_fee; ?></p>
