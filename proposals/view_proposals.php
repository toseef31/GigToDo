							...
							<div class="col-12 col-md-6">
								<nav class="list-page-nav">
									<div class="nav nav-tabs" id="nav-tab" role="tablist">
										...
										?>
										<a class="nav-item nav-link deep-sky-blue" id="modification-tab" data-toggle="tab" href="#nav-modification" role="tab" aria-controls="nav-modification" aria-selected="false">Modification <span class="badge bg-dark"><?php echo $count_proposals; ?></span></a>
									</div>
								</nav>
							</div>
						</div>
