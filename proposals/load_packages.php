...
<tr>
<td><h4><?php echo $package_name; ?></h4></td>
</tr>
<tr>
<td><textarea class="form-control form-control-sm description-value-<?php echo $package_id; ?>" required=""><?php echo $description; ?></textarea></td>
</tr>
...
<small><?php echo $attribute_name; ?></small>

<div class="input-group">

<input class="form-control form-control-sm attribute-value-<?php echo $attribute_id; ?>" value="<?php echo $attribute_value; ?>" data-attribute="<?php echo $attribute_id; ?>">

<button style="font-size:15px;" class="btn btn btn-success save-attribute-<?php echo $attribute_id; ?> input-group-addon" data-attribute="<?php echo $attribute_id; ?>">
<i class="fa fa-floppy-o"></i>&nbsp;Save
</button>

<button class="btn btn btn-success delete-attribute input-group-addon" data-attribute="<?php echo $attribute_name; ?>">
...
<input class="form-control form-control-sm" name="delivery_time" value="<?php echo $delivery_time; ?>" required>
...
<input type="number" min="5" class="form-control form-control-sm" name="price" value="<?php echo $price; ?>" required>
...
data: { d_proposal_price : <?php echo $d_proposal_price; ?>, proposal_id: <?php echo $proposal_id; ?> },
...
?>
$(".save-attribute-<?php echo $attribute_id; ?>").on('click', function(event){
...
var attribute_value = $('.attribute-value-<?php echo $attribute_id; ?>').val();
