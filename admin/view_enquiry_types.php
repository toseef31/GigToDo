          ...
          <div class="table-responsive">
            ...
            <table class="table-bordered table">
              ...
              <tbody>
                ...
                $enquiry_title_arabic = $row_enquiry_types->enquiry_title_arabic;
                $i++;
                ?>
                <tr>
                  <td>
                  ...
                  <td>
                    <?php echo $enquiry_title_arabic; ?>
                  </td>
                  <td>
                    <a href="index?delete_enquiry_type=<?php echo $enquiry_id; ?>" class="btn btn-danger">
                      <i class="fa fa-trash text-white"></i> <span class="text-white">Delete</span>
                    </a>
                  </td>
                  <td>
                    <a href="index?edit_enquiry_type=<?php echo $enquiry_id; ?>" class="btn btn-success">
