...
<td>
<a href="../proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>" target="_blank" class="text-success"><?php echo $proposal_title; ?></a>
</td>
...
<a class="dropdown-item" href="index?delete_proposal_report=<?php echo $id; ?>">
