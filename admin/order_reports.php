...
<td><?php echo $i; ?></td>
<td><a href="../<?php echo $reporter_user_name; ?>" target="_blank" class="text-success"><?php echo $reporter_user_name; ?></a></td>
<td><a href="index?single_order=<?php echo $content_id; ?>" target="_blank" class="text-success">#<?php echo $order_number; ?></a></td>
