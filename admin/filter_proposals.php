...
$get_proposals = $db->query("select * from proposals where proposal_status not in ('modification','draft','deleted') and (delivery_id=:d_id and level_id=:l_id and proposal_cat_id=:c_id) order by 1 DESC",array("d_id"=>$get_delivery_id,"l_id"=>$get_level_id,"c_id"=>$get_cat_id));
...
<a href="index?toprated_proposal=<?php echo $proposal_id; ?>" title="Make Your Proposal Top Rated">
<i class="fa fa-heart" aria-hidden="true"></i>
</a>
<?php }else{ ?>
<a class="text-danger" href="index?removetoprated_proposal=<?php echo $proposal_id; ?>" title="Remove Proposal From Top Rated Listing.">
