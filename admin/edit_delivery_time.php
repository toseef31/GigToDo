...
$delivery_title_arabic = $row_edit->delivery_title_arabic;

$delivery_proposal_title = $row_edit->delivery_proposal_title;

$delivery_proposal_title_arabic = $row_edit->delivery_proposal_title_arabic;
        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" name="delivery_title_arabic" class="form-control" value="<?php echo $delivery_title_arabic; ?>" required>
                <small class="form-text text-muted">
                This delivery title will show on categories, sub categories and search related pages.
                </small>
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" name="delivery_proposal_title" class="form-control" value="<?php echo $delivery_proposal_title; ?>" required>
                <small class="form-text text-muted">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" name="delivery_proposal_title_arabic" class="form-control" value="<?php echo $delivery_proposal_title_arabic; ?>" required>
                <small class="form-text text-muted">
                This delivery title will show on proposal related pages.
                </small>
              </div>
...
<?php
    ...
    $delivery_title_arabic = $input->post('delivery_title_arabic');

    $delivery_proposal_title = $input->post('delivery_proposal_title');

    $delivery_proposal_title_arabic = $input->post('delivery_proposal_title_arabic');

    $update_delivery_time = $db->update("delivery_times",array("delivery_title" => $delivery_title,"delivery_title_arabic" => $delivery_title_arabic,"delivery_proposal_title" => $delivery_proposal_title,"delivery_proposal_title_arabic" => $delivery_proposal_title_arabic),array("delivery_id" => $delivery_id));
