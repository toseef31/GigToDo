...
<div class="container mt-5 mb-3">
	<div class="row">
		<div class="col-md-12">
			<div class="card mb-3">
				<div class="card-body">
					<h5 class="float-left mt-2"> Your Cart (<?= $count_cart; ?>) </h5>
	...
	<div class="row cart-add-sect" id="cart-show">
		<div class="col-md-7">
				...
				<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-lg-9">
								<a href="proposals/<?= $proposal_seller_user_name; ?>/<?= $proposal_url; ?>">
									...
									<ul class="ml-4 mb-2" style="list-style-type: circle;">
                  	<?php
                    while($extra = $cart_extras->fetch()){
                      $name = $extra->name;
                      $price = $extra->price;
                    ...
                    ?>
	                  ...
	                  <?php } ?>
						...
						<hr>
						<h6 class="clearfix">
							<?= ($video == 1)?"Proposal Video Call Minutes":"Proposal/Service Quantity"; ?>
							<strong class="float-right price ml-2 mt-2"> <?= $s_currency; ?><?= $proposal_price * $proposal_qty; ?> </strong>
          ...
          <?php } ?>
					<h3 class="float-right">Total: <?= $s_currency; ?><?= $total; ?> </h3>
				</div>
			</div>
			<?php
			if($count_cart == 0){
		...
		<div class="col-md-5">
			<div class="card">
				<div class="card-body cart-order-details">
					<p>Cart Subtotal <span class="float-right"><?= $s_currency; ?><?= $total; ?></span></p>
					<hr>
					...
					<hr>
					<?php } ?>
					<p>Processing Fee <span class="float-right"><?= $s_currency; ?><?= $processing_fee; ?></span></p>
					<hr>
					<p>Total<span class="font-weight-bold float-right"><?= $s_currency; ?><?= $total + $processing_fee; ?> </span></p>
					<hr>
					<?php if($count_cart == 0){ ?>
