                    ...
                    <div class="col-md-6">
                      <div class="how-it-content mt-50">
                        ...
                        <ul>
                          ...
                          <li>In today’s world, finding qualified, expert service providers can be a hassle. eMongez makes it easy to find and reach out to the perfect Freelancer for your project. No longer will you have to settle for inadequate agencies that over promise and under deliver.</li>
                          <li>With eMongez, you can verify the credentials, previous work, and client testimonies of each Freelancer using the eMongez platform.</li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 order-md-last">
                      <div class="how-it-content mt-50">
                        ...
                        <ul>
                          ...
                          <li>As they say, competition brings out the best. Taking the time to carefully browse through our variety of Freelancer will allow you to see the very best that the freelancing community has to offer.</li>
                    ...
                    <div class="col-md-6">
                      <div class="how-it-content mt-50">
                        ...
                        <ul>
                          ...
                          <li>Our incredible platform guarantees that Freelancer only promote the services that they are competent in.</li>
                      ...
                      <div class="how-it-content mt-50">
                        ...
                        <p class="text">
                          <ul>
                            ...
                            <li>Your payment details will never be shared with any freelancer, and they only receive the payment once you have reviewed and approved your order.</li>
                            <li>The best part is that eMongez manages the transfer of funds from client to freelancer. This ensures that freelancers are motivated to go above and beyond for Clients.</li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-md-6 order-md-first">
                      ...
                      <div class="col-md-6">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            ...
                            <li>We want to provide a safe place where Clients and Freelancer can come together and create projects that change the world.</li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row align-items-center" id="freelancer_hire">
                      <div class="col-md-6 order-md-last">
                        <div class="how-it-content mt-50">
                          ...
                          <ul>
                            <li>eMongez makes it incredibly simple to find quality clients that need your services. Our platform is dedicated to making sure that the best Freelancer are matched with the appropriate Client.</li>
                            ...
                            <li>As you complete more projects, clients will be able to see the previous ratings from your past jobs. Freelancer with the highest number of positive reviews are in the highest demand.</li>
