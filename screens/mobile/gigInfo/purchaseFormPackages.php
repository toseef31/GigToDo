...
<h5 class="mt-2 mb-3"><i class="fa fa-refresh"></i> &nbsp; <?php echo $row->revisions; ?> Revisions </h5>
...
<a href="#" data-toggle="modal" data-target="#login-modal" class="btn btn-order">
	<strong>Order Now (<?php echo $s_currency; ?><span class="<?php echo $priceClass; ?>"><?php echo $price; ?></span>)</strong>
</a>
...
<?php }else{ ?>
<form method="post" action="../../checkout" id="checkoutForm<?php echo $packagenum; ?>"><!--- form Starts --->
  ...
  <?php } ?>
	...
	<strong>
	Order Now (<?php echo $s_currency; ?><span class="<?php echo $priceClass; ?>"><?php echo $price; ?></span>)
	</strong>
	</button>
