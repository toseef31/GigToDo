...
<form method="post" class="clearfix mb-3">
  <div class="form-group row">
    ...
    <div class="col-md-8">
      <input type="text" name="seller_paypal_email" value="<?= $login_seller_paypal_email; ?>" placeholder="Enter paypal email" class="form-control" required >
    </div>
  </div>
...
<form method="post" class="clearfix mb-3">
  <div class="form-group row">
    ...
    <div class="col-md-8">
      <input type="text" name="m_account_number" value="<?= $login_seller_account_number; ?>" placeholder="Enter Account Number" class="form-control" required>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-md-4 col-form-label"> Account/Owner Name </label>
    <div class="col-md-8">
      <input type="text" name="m_account_name" value="<?= $login_seller_account_name; ?>" placeholder="Enter Account/Owner Name" class="form-control" required>
    </div>
  </div>
...
<form method="post" class="clearfix mb-3">
  <div class="form-group row">
    ...
    <div class="col-md-8">
      <input type="text" name="seller_wallet" value="<?= $login_seller_wallet; ?>" placeholder="Enter Wallet Address" class="form-control"/>
...
<ul class="list-unstyled <?= $floatRight ?>">
  ...
  <li><i class="fa fa-hand-o-right"></i> Your profile and services won't be shown on <?= $site_name; ?> anymore. </li>
...
<form method="post">
  ...
  <div class="form-group">
    ...
    <select name="deactivate_reason" class="form-control" required>
      ...
      <option>I have another <?= $site_name; ?> account</option>
