...
<ul class="buyables m-b-25 list-unstyled <?=($lang_dir == "right" ? 'text-right':'')?>">
  ...
  <li class="<?=($lang_dir=="right" ? 'text-right':'')?>">
    <label class="<?=($lang_dir=="right"?'text-right':'')?>">
      <input class="mb-2" style="width:15px;height:15px;" type="checkbox" name="proposal_extras[<?php echo $i; ?>]" data-packagenum="<?php echo $packagenum; ?>" value="<?php echo $id; ?>" form="<?php echo $formId; ?>">
