...
<div class="card-body">
	...
	<input class="form-control" readonly="" value="<?php echo $site_url."/referral.php?proposal_id=$proposal_id&referral_code=".$proposal_referral_code."&referrer_id=$login_seller_id"; ?>">
	<?php }else{ ?>
