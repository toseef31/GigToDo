...
$edit_admin = $db->select("admins",array('admin_id'=>$admin_id));		
                    ...
                    <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="admin_name" class="form-control" required value="<?php echo $a_name; ?>">
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="admin_email" class="form-control" required value="<?php echo $a_email; ?>">
                       ...
                       <label class="col-md-3 control-label"> Admin Job : <br> <span class="text-muted"> ADMIN, ADMIN USA etc.</span> </label>
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                         ...
                         <textarea name="admin_about" class="form-control" rows="3"><?php echo $a_about; ?></textarea>
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="admin_images/<?php echo $showImage; ?>" width="70" height="70">
...
$update_admin = $db->update("admins",array("admin_name"=>$admin_name,"admin_email"=>$admin_email,"admin_pass"=>$encrypt_password,"admin_image"=>$admin_image,"admin_contact"=>$admin_contact,"admin_country"=>$admin_country,"admin_job"=>$admin_job,"admin_about"=>$admin_about),array("admin_id"=>$a_id));
...
<script>
    ...
    swal({
      type: 'success',
      text: 'Your User Profile Has Been Updated Successfully, So Please Login Again.',
      timer: 4000,
      onOpen: function(){
      swal.showLoading()
      }
