	...
	<div class="modal-dialog  modal-dialog-centered customer-order" role="document">
		<div class="modal-content">
			...
			<div class="form-group d-flex flex-row align-items-center justify-content-between border-top pt-30">
				...
				<?php } ?>
				<!-- End we Accept Button -->
				<!-- We Accept Button -->
				<?php if($enable_weaccept == "yes"){ ?>
				<form action="weaccept_cash.php" method="post" id="weaccept-cash"><!--- paypal-form Starts --->
				<button type="submit" name="weaccept_cash" class="button">We Accept Cash</button>
				</form><!--- paypal-form Ends --->
				<?php } ?>
				<!-- End we Accept Button -->
				<!-- We Accept Button -->
				<?php if($enable_weaccept == "yes"){ ?>
				<form action="weaccept_kiosk.php" method="post" id="weaccept-kiosk"><!--- paypal-form Starts --->
				<button type="submit" name="weaccept_valu" class="button">We Accept Kiosk</button>
				</form><!--- paypal-form Ends --->
				<?php } ?>
				<!-- End we Accept Button -->
				<?php if($enable_stripe == "yes"){ ?>
...
$('#weaccept-valu').hide();
$('#weaccept-kiosk').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "yes"){ ?>
$('#2checkout-form').hide();
$('#credit-card-form').hide();
$('#coinpayments-form').hide();
$('#payza-form').hide();
$('#mobile-money-form').hide();
$('#paystack-form').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "no" and $enable_stripe == "yes"){ ?>
$('#2checkout-form').hide();
$('#coinpayments-form').hide();
$('#payza-form').hide();
$('#mobile-money-form').hide();
$('#paystack-form').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "no" and $enable_stripe == "no" and $enable_2checkout == "yes") { ?>
$('#coinpayments-form').hide();
$('#payza-form').hide();
$('#mobile-money-form').hide();
$('#paystack-form').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "no" and $enable_stripe == "no" and $enable_2checkout == "no" and $enable_payza == "yes") { ?>
$('#coinpayments-form').hide();
$('#mobile-money-form').hide();
$('#paystack-form').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "no" and $enable_stripe == "no" and $enable_2checkout == "no" and $enable_payza == "no" and $enable_coinpayments == "yes") { ?>
$('#mobile-money-form').hide();
$('#paystack-form').hide();
<?php }elseif($enable_paypal == "no" and $enable_weaccept == "no" and $enable_stripe == "no" and $enable_2checkout == "no" and $enable_payza == "no" and $enable_coinpayments == "no" and $enable_paystack == "yes") { ?>
$('#mobile-money-form').hide();
<?php } ?>
<?php } ?>
