...
$(function(){
		new Card({
			form: document.querySelector('#paymob_checkout'),
...
function update_two_hidden_fields(){
	$("#mm").val($("#mmyy").val().split('/')[0].replace(' ', '').replace(' ', ''));
	$("#yy").val($("#mmyy").val().split('/')[1].replace(' ', '').replace(' ', ''));
	$("#card_number").val($("#number").val().replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', ''));
}