              ...
              <div class="col-12 col-md-4">
                ...
                <div class="blog-recent-posts d-flex flex-column">
                  ...
                  <div class="blog-recent-posts-body d-flex flex-column">
                    <?php 
                      $get_articles = $db->query("select * from knowledge_bank where language_id=1 order by 1 DESC LIMIT 0,3");
                    ...
                    ?>
                    <a class="blog-recent-posts-item d-flex flex-row" href="<?php echo $article_url; ?>">
                      <div class="image">
