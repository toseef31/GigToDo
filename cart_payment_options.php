							...
							<div class="row">
								...
								<div class="col-11">
									<p class="lead mt-2">
					                   ...
					                   Personal Balance - <b><?= $login_seller_user_name; ?></b> <span class="text-success font-weight-bold"><?= $s_currency; ?><?= $current_balance; ?></span>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12 mb-3">
					<div class="card payment-options">
						...
						<div class="card-body">
							...
							<?php
							if($current_balance < $sub_total){
							if($enable_paypal == "no" and $enable_stripe == "no" and $enable_2checkout == "no"){ 
							echo "checked";
							}
							}
							?>>
		...
		<div class="col-md-5">
			<div class="card">
				<div class="card-body cart-order-details">
					<p>Cart Subtotal <span class="float-right"><?= $s_currency; ?><?= $sub_total; ?></span></p>
					<hr>
					<p class="processing-fee">Processing Fee <span class="float-right"><?= $s_currency; ?><?= $processing_fee; ?> </span></p>
					<hr class="processing-fee">
					<p>Total <span class="float-right font-weight-bold total-price"><?= $s_currency; ?><?= $total; ?></span></p>
					<hr>
		<?php if($current_balance >= $sub_total){ ?>
